...
class ShadcnAlertView extends StatefulWidget {
  final String title;
  ...
  final ShadcnAlertDelegate? delegate;
  final ShadcnAlertViewModel? viewModel;

  const ShadcnAlertView({
    super.key,
    required this.title,
    this.description,
    this.icon,
  ...
  @override
  State<ShadcnAlertView> createState() => _ShadcnAlertViewState();
}

class _ShadcnAlertViewState extends State<ShadcnAlertView>
  ...
  void _dismiss() {
    ...
    widget.delegate?.onHide();
    
    _animationController.reverse().then((_) {
      widget.delegate?.onDismiss();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.description != null) ...[
                      ...
                      Text(
                        ...
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(
                              color:
                                  _getDescriptionColor(alertColors, colorScheme),
                            ),
                      ),
                    ],
                    if (widget.action != null) ...[
                      ...
                      GestureDetector(
                        onTap: () => widget.delegate?.onAction(),
                        child: widget.action!,
                      ),
                    ],
                  ],
