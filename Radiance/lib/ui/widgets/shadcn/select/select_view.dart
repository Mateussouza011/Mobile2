...
class ShadcnSelectView<T> extends StatefulWidget {
  ...
  final ShadcnSelectDelegate<T>? delegate;
  final ShadcnSelectViewModel<T>? viewModel;

  const ShadcnSelectView({
    super.key,
  ...
  @override
  State<ShadcnSelectView<T>> createState() => _ShadcnSelectViewState<T>();
}

class _ShadcnSelectViewState<T> extends State<ShadcnSelectView<T>> {
  ...
  void _onFocusChange() {
    widget.delegate?.onFocusChanged(_focusNode.hasFocus);
  ...
  void _onSearchChanged(String query) {
    widget.delegate?.onSearchChanged(query);
    setState(() {
      if (query.isEmpty) {
        _filteredOptions = widget.options;
      } else {
